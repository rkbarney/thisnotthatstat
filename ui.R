  ...
  sidebarLayout(
    sidebarPanel(
      ...
      p("ThisNotThatStat is built on the", 
        a(href = 'https://shiny.rstudio.com/', 'shiny development framework for R'), 
        ' and uses', 
        a(href='https://github.com/tidyverse/haven', 'haven'), 'to perform file conversions.'),
      HTML("<hr>"),
      p("Please log issues or feature requests to", 
        a(href = 'https://github.com/rkbarney/thisnotthatstat', 'github.')), 
      HTML("<hr>"),
      p("Contact ", 
